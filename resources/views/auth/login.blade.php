                                            ...
                                            <div class="pt-0">
                                                <form action="{{ route('login') }}" method="POST" class="my-4">
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input class="form-control" name="email" type="email" id="email" required placeholder="Enter your email" value="u@u">
                                                    </div>
                                                
                                                    <div class="form-group mb-3">
                                                        <label for="password" class="form-label">Password</label>
                                                        <input class="form-control" name="password" type="password" id="password" required placeholder="Enter your password" value="a">
                                                    </div>
                                                ...
                                                <div class="text-center text-muted mb-4">
                                                    <p class="mb-0">Donot have an account ?<a class='text-primary ms-2 fw-medium' href='auth-login.html'>Login here</a></p>
                                                </div>
